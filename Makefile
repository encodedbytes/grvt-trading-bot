...
.PHONY: venv install test run once instrument position-config status thresholds recovery-status notify-test docker-build docker-run docker-once docker-up docker-restart docker-logs docker-down clean
